...
export const ProfileScreen: React.FC<ProfileScreenProps> = ({ onLogout, onShowPrivacyPolicy, onShowTermsOfService, onShowAdminStats }) => {
  ...
  return (
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Animated.View style={[styles.section, sectionsAnimatedStyle]}>
        ...
        {isAdmin && (
          <TouchableOpacity style={styles.settingItem} onPress={onShowAdminStats}>
        ...
        <TouchableOpacity style={styles.settingItem} onPress={onShowPrivacyPolicy}>
          <Text style={styles.settingText}>{t('profile.privacy')}</Text>
          <Text style={styles.settingValue}>→</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.settingItem} onPress={onShowTermsOfService}>
          <Text style={styles.settingText}>{t('profile.termsOfService')}</Text>
          <Text style={styles.settingValue}>→</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.settingItem} onPress={() => setShowSupportModal(true)}>
      ...
      <Animated.View style={[styles.footer, sectionsAnimatedStyle]}>
        <Text style={styles.footerText}>FridgeWise AI v2.0.0</Text>
      </Animated.View>
    </ScrollView>
